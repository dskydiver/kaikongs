...
const Holdings = () => {
    ...
    const fetchNFTs = async () => {
        ...
        combinedArray.sort((a, b) => a.tokenPrice - b.tokenPrice);
                        ...
                        <div id="dropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow">
                            <ul className="py-2 w-fit text-sm text-gray-700 " aria-labelledby="dropdownDefaultButton">
                                <li>
                                    ...
                                    <a href='/sort-price-lh' id="p-l-h" className="active__option block w-full px-4 py-2 hover:bg-gray-100">Price, Low To High</a>

                                    <a href='/sort-price-hl' id="p-h-l" className="block w-full px-4 py-2 hover:bg-gray-100">Price, High To Low</a>
                                </li>
                            </ul>
                        </div>
