      ...
      <header className="text-gray-600 body-font bg-white">
          ...
          <div className="container mx-auto flex p-5 flex-row items-center justify-between">
            ...
            <div className='hidden lg:block'>
              <a href='/connect-kardiachain' className='text-sm flex gap-3 p-2 bg-gray-200  items-center rounded-lg'>Add Galaxias Mainnet <img src="/metamask.png" width='30' alt="metamask icon" /></a>
            </div>

            <div className="social__icons hidden md:flex  gap-4 text-xl text-black">
              <a href="https://twitter.com/KaiKongsNFT" rel='noreferrer' target='_blank'> <BsTwitter/> </a>
              {/* <a href="https://t.me/kardiakingdom" rel='noreferrer' target='_blank'> <BsTelegram/> </a> */}
              <a href="https://discord.com/invite/gWEp6aDcuv" rel='noreferrer' target='_blank'> <FaDiscord/> </a>
            </div>
            ...
            <nav className="flex flex-wrap items-center text-base justify-center">
              ...
              <a href='/kongs' className="mr-5 hover:text-gray-900">Profile</a>
            </nav>
          </div>
      </header>

        <div className='bg-gray-200 py-2 text-center'>
          <span>If The Marketplace Doesn't Load, Refresh and Wait 5 Seconds. Also, Connect To Kai RPC</span>
        </div>
