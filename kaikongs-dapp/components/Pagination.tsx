    ...
    return (
        ...
        <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {pages.map((page, index) => 
                <a key={index} href="#" aria-current="page" onClick={() => onPageChange(page)} className="page-item relative z-10 inline-flex items-center border px-4 py-2 text-sm font-medium focus:z-20">{page }</a>
            )}
